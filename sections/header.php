...
<!-- Header -->
<header class="header full-box" style="background-color: #D6EAF8;">
	    <div class="header-brand text-center full-box">
	        <a href="index.php">
	            <img src="assets/img/descarga.png" alt="logo" class="img-fluid">
	        </a>
	    </div>
	    ...
	    <div class="header-options full-box">
	        ...
	        <div class="header-button full-box text-center btn-login-menu" >
	            ...
	            <div class="div-bordered popup-login" style="background-color: #D6EAF8;">

	                <!-- Inicio de sesion -->
	                <span class="text-center poppins-regular font-weight-bold">Inicio de sesión como:</span>
