...
<body>
        ...
        <script src="js/script.js?v=280124"></script>      
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                   <h1 class="modal-title text-center text-danger">Inserta Nuevo Usuario<h1>
    ...
    $(document).ready(function () {
        ...
        $('#verMapaBtn').on('click', function () {
            ...
            var mapOptions = {
                center: ubicacion,
                zoom: 15,
                tilt: 45, // Ángulo de inclinación para simular 3D
