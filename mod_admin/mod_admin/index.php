                                            ...
                                            <ul class="timeline-list">
                                                <li class="active">
                                                    ...
                                                    <div class="timeline-content">
                                                        <p class="push-bit"><a href="#"><strong>Jordan Carter</strong></a></p>
                                                        <p class="push-bit">The trip was an amazing and a life changing experience!!</p>
                                                        <p class="push-bit"><a href="#" class="btn btn-xs btn-primary"><i class="fa fa-file"></i> Read the article</a></p>
                                                        <div class="row push">
                                                ...
                                                <li class="active">
                                                    ...
                                                    <div class="timeline-content">
                                                        <p class="push-bit"><a href="#"><strong>Ella Winter</strong></a></p>
